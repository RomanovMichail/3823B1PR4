...
//                    }
//                    else {
//                        Variable new_lexem(exp.substr(start_pos, curr_pos - start_pos));
//                        _expression.push_back(new_lexem);
//                    }
//                }
//            }
...
//    }
//    void check() {
//        TStackDM<char> stack = TStackDM<char>();
//        for (auto it = _expression.begin(); it != _expression.end(); it++) {
//            if (it._type == OPERATION) {
...
//                }
//                else if (prev->_type == BRACKET || prev->_type == OPERATION || prev->_type == FUNCTION) {
//                    throw std::logic_error("...");
//                }
//                else if (next->_type == BRACKET && next->name() == ")")
//            }
//        }
//    }
